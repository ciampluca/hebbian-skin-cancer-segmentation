...
EXPS=(
    ...
    kvasirSEG/hunet-swta_t_ft   # da fare k 0.002
    #kvasirSEG/hunet2-swta
    #kvasirSEG/hunet2-swta_ft
    #################################
    # DataScienceBowl2018 Dataset
    #################################
    datasciencebowl2018/hunet-swta      # da fare k 0.002
    datasciencebowl2018/hunet-swta_ft   # da fare k 0.002
    datasciencebowl2018/hunet-swta_t    # da fare k 0.002
    datasciencebowl2018/hunet-swta_t_ft     # da fare k 0.002
